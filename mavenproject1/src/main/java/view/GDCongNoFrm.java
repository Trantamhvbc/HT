...
public class GDCongNoFrm extends javax.swing.JFrame {
    ...
    void loadDanhSachChiTietCongNo() {
        ...
        for (int i = 0; i < listCongNoChiTiet.size(); i++) {
            ...
            defaultTableModel.addRow(new Object[]{stt, cap.getLoaiPhieu(), cap.getSoPhieu(), cap.getNgayLap(), dinhDangTien(cn.getSoTienNo()), dinhDangTien(cap.getSoTien()), dinhDangTien(luyKe)});
        }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jButtonLamMoi, jButtonThanhToan, jButtonTim});
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButtonLamMoi, jButtonThanhToan, jButtonTim, jTextFieldTimKiem});
